...
import 'package:thriftify_fyp_1/features/personalization/controllers/update_username_controller.dart';
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              "Use real username for easy verification",
