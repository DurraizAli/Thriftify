...
class AllProducts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.find<ProductController>();//controller will be fetched from here 
            ...
            children: [
              ...
              TGridLayout(
                  ...
                  itemBuilder: (_, index) => const TProductCardVertical(
                        ...
                        brand: 'Nike',
                        price: '200',
                        imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVaGVEN2IZlwdNcm4B8wCncaFimFUf72v8pQ&s',
                      )) //these have to be working with firebase.
            ],
          ),
        ),
      ),
